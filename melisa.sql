...
CREATE TABLE IF NOT EXISTS `melisa`.`applicationsRoles` (
  ...
  UNIQUE INDEX `idApplication_rol_UNIQUE` (`idApplication` ASC, `role` ASC),
...
-- Table `melisa`.`gates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`gates` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `melisa`.`systemsSecurity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`systemsSecurity` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `melisa`.`gatesSystems`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`gatesSystems` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `idGate` SMALLINT NOT NULL,
  `idSystemSecurity` SMALLINT NOT NULL,
  `active` TINYINT NOT NULL DEFAULT 1,
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` DATETIME NULL,
  `idIdentityUpdated` VARCHAR(36) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_gatesSystems_gates1_idx` (`idGate` ASC),
  INDEX `fk_gatesSystems_systemsSecurity1_idx` (`idSystemSecurity` ASC),
  UNIQUE INDEX `idGate_idSystemSecurity_UNIQUE` (`idGate` ASC, `idSystemSecurity` ASC),
  CONSTRAINT `fk_gatesSystems_gates1`
    FOREIGN KEY (`idGate`)
    REFERENCES `melisa`.`gates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_gatesSystems_systemsSecurity1`
    FOREIGN KEY (`idSystemSecurity`)
    REFERENCES `melisa`.`systemsSecurity` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `melisa`.`securityGroups`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`securityGroups` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
  `idIdentityCreated` VARCHAR(36) NOT NULL,
  `name` VARCHAR(75) NOT NULL,
  `active` TINYINT NOT NULL DEFAULT 1,
  `order` SMALLINT NOT NULL DEFAULT 0,
  `oneAllowed` TINYINT NOT NULL DEFAULT 1,
  ...
  `updatedAt` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_securityGroups_identities1_idx` (`idIdentityCreated` ASC),
  CONSTRAINT `fk_securityGroups_identities1`
    FOREIGN KEY (`idIdentityCreated`)
    REFERENCES `melisa`.`identities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `melisa`.`securityGroupsSystems`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`securityGroupsSystems` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
  `idSecurityGroup` SMALLINT NOT NULL,
  `idSystemSecurity` SMALLINT NOT NULL,
  `idIdentityCreated` VARCHAR(36) NOT NULL,
  `active` TINYINT NOT NULL DEFAULT 1,
  `order` SMALLINT NOT NULL DEFAULT 0,
  ...
  `updatedAt` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_securityGroupsSystems_securityGroups1_idx` (`idSecurityGroup` ASC),
  INDEX `fk_securityGroupsSystems_systemsSecurity1_idx` (`idSystemSecurity` ASC),
  INDEX `fk_securityGroupsSystems_identities1_idx` (`idIdentityCreated` ASC),
  UNIQUE INDEX `idSecurityGroup_idSystemSecurity_UNIQUE` (`idSecurityGroup` ASC, `idSystemSecurity` ASC),
  CONSTRAINT `fk_securityGroupsSystems_securityGroups1`
    FOREIGN KEY (`idSecurityGroup`)
    REFERENCES `melisa`.`securityGroups` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_securityGroupsSystems_systemsSecurity1`
    FOREIGN KEY (`idSystemSecurity`)
    REFERENCES `melisa`.`systemsSecurity` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_securityGroupsSystems_identities1`
    FOREIGN KEY (`idIdentityCreated`)
    REFERENCES `melisa`.`identities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `melisa`.`securityGroupsGates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`securityGroupsGates` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
  `idSecurityGroup` SMALLINT NOT NULL,
  `idGate` SMALLINT NOT NULL,
  `idIdentityCreated` VARCHAR(36) NOT NULL,
  ...
  `updatedAt` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_securityGroupsGates_securityGroups1_idx` (`idSecurityGroup` ASC),
  INDEX `fk_securityGroupsGates_gates1_idx` (`idGate` ASC),
  INDEX `fk_securityGroupsGates_identities1_idx` (`idIdentityCreated` ASC),
  UNIQUE INDEX `idSecurityGroup_idGate_UNIQUE` (`idSecurityGroup` ASC, `idGate` ASC),
  CONSTRAINT `fk_securityGroupsGates_securityGroups1`
    FOREIGN KEY (`idSecurityGroup`)
    REFERENCES `melisa`.`securityGroups` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_securityGroupsGates_gates1`
    FOREIGN KEY (`idGate`)
    REFERENCES `melisa`.`gates` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_securityGroupsGates_identities1`
    FOREIGN KEY (`idIdentityCreated`)
    REFERENCES `melisa`.`identities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `melisa`.`securityGroupsTypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`securityGroupsTypes` (
  `id` SMALLINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(75) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC))
ENGINE = InnoDB
COMMENT = '1 one system, 2 group system one allowed, 3 group system all allowed';


-- -----------------------------------------------------
-- Table `melisa`.`rolesIdentities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`rolesIdentities` (
  `id` VARCHAR(36) NOT NULL,
  `idApplicationRol` VARCHAR(36) NOT NULL,
  `idIdentity` VARCHAR(36) NOT NULL,
  `idIdentityCreated` VARCHAR(36) NOT NULL,
  ...
  `updatedAt` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_rolesIdentities_applicationsRoles1_idx` (`idApplicationRol` ASC),
  INDEX `fk_rolesIdentities_identities1_idx` (`idIdentity` ASC),
  INDEX `fk_rolesIdentities_identities2_idx` (`idIdentityCreated` ASC),
  UNIQUE INDEX `idApplicationRol_idIdentity_UNIQUE` (`idApplicationRol` ASC, `idIdentity` ASC),
  CONSTRAINT `fk_rolesIdentities_applicationsRoles1`
    FOREIGN KEY (`idApplicationRol`)
    REFERENCES `melisa`.`applicationsRoles` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_rolesIdentities_identities1`
    FOREIGN KEY (`idIdentity`)
    REFERENCES `melisa`.`identities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_rolesIdentities_identities2`
    FOREIGN KEY (`idIdentityCreated`)
    REFERENCES `melisa`.`identities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `melisa`.`usersAvatars`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `melisa`.`usersAvatars` (
  `id` CHAR(36) NOT NULL,
  `idUser` CHAR(36) NOT NULL,
  `idFileAvatar` CHAR(36) NOT NULL,
  `active` TINYINT NOT NULL DEFAULT 1,
  `isDefault` TINYINT NOT NULL DEFAULT 0,
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_usersAvatars_users1_idx` (`idUser` ASC),
  UNIQUE INDEX `idUser_idFileAvatar_UNIQUE` (`idUser` ASC, `idFileAvatar` ASC),
  CONSTRAINT `fk_usersAvatars_users1`
    FOREIGN KEY (`idUser`)
    REFERENCES `melisa`.`users` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
